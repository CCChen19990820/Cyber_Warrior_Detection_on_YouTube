...
def Community_Detection():
	...
	appear_data_old.to_csv(r'~/../../mnt/c/Users/Jeff/Desktop/專題資料/Data/dtw_normalized/sorted_'+Channelquery+'.csv', encoding="utf-8")
	...
	for i in range(0,len(user_edge)):
		...
		b = {'myweight':appear_data_old['min_distance'][i]}
		user_edge[i] = (*a,b)
	...
	cluster_df.to_csv(r'~/../../mnt/c/Users/Jeff/Desktop/專題資料/Data/dtw/cluster_'+Channelquery+'.csv', encoding="utf-8-sig")
