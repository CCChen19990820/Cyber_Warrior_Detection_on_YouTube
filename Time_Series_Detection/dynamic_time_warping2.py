...
Channelquery = input("少康戰情室、關鍵時刻、比特王出任務，Choose one to search:")
...
def DTW_similarity(time_list):
	...
	for i in user_list:
		...
		zero_count = 0
		#print('countuser = ' +str(countuser)+'totaluser'+str(totaluser))
		countuser+=1
		temp2 = []
